...
import com.ssafy.mm.exception.UnAuthorizedException;
...
//	SALT는 토큰 유효성 확인 시 사용하기 때문에 외부에 노출되지 않게 주의해야 한다.
	private static final String SALT = "movemovie_JS";
...
//		return create(key, data, "refresh-token", 1000 * 30 * ACCESS_TOKEN_EXPIRE_MINUTES);
	...
	public <T> String create(String key, T data, String subject, long expire) {
		// Payload 생성 : 생성일 (IssuedAt), 유효기간 (Expiration), 
...
//			return testMap;
	...
	public String getUserId() {
		return (String) this.get("user").get("user_email");
	}
