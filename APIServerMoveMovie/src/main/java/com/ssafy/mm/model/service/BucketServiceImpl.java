...
public class BucketServiceImpl implements BucketService {
	...
	private static BucketMapper bucketMapper;
	private static Bucket_Detail_List_Mapper bucketDetailMapper;
	private static My_Bucket_List_Mapper bucketMyListMapper;
	
	@Autowired
	public BucketServiceImpl(BucketMapper bucketMapper, Bucket_Detail_List_Mapper bucketDetailMapper, My_Bucket_List_Mapper bucketMyListMapper) throws Exception {
