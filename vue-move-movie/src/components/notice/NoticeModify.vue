                    ...
                    <b-card class="bg-transparent">
                        <b-card-header>
                            <div class="row">
                                ...
                                <b-form-input class="col-md-6" v-model="notice.notice_title" placeholder="Enter your name"></b-form-input>
                                <div class="col-md-3"></div>
                            </div>
                            <div class="row">
                        ...
                        <b-card-footer>
                            <div class="row">
                                ...
                                <b-button class="mr-3" variant="primary" @click="Modify">수정</b-button>
