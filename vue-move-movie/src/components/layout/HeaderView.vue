        ...
        <b-container fluid="xl">
          ...
          <b-navbar-brand>
            <router-link to="/" style="text-decoration: none; cursor: pointer">
              <img
                src="@/assets/logo.png"
                class="d-inline-block align-middle header-logo mr-2"
                width="100px"
                alt="ssafy"
              />
          ...
          <b-collapse id="nav-collapse" is-nav>
            <b-navbar-nav>
              <b-nav-item
                ><router-link to="/media" class="nav-link p-md-0"
                  >타이틀 기반 검색</router-link
                ></b-nav-item
              >
              <b-nav-item
                ><router-link to="/media/list/location" class="nav-link p-md-0"
                  >주소 기반 검색</router-link
                ></b-nav-item
              >
              <b-nav-item
                ><router-link to="/bucket" class="nav-link p-md-0"
                  >버킷 살펴보기</router-link
                ></b-nav-item
              >
          ...
          >
            <div v-if="userInfo">
              {{ userInfo.user_nickname }} 님 환영합니다!!
            </div>
            <b-icon-basket2-fill
              id="b-icon-basket2-fill"
              class="justify-content-end h2 pt-1 mr-3"
