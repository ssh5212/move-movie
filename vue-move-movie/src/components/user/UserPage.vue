    ...
    <div class="container">
      <div class="row justify-content-xl-center my-5 align-items-center">
        <div class="col-md-4" style="background-color: white">
          ...
          <button type="button" class="btn btn-dark mb-2" @click="goEdit">
            개인정보 수정하기</button
          ><br />
          <button type="button" class="btn btn-dark mb-5" @click="goDropout">
            탈퇴하기
          </button>
        </div>
        <div class="col-md-1"></div>
        <div
          class="col-md-7 overflow-auto"
